...
public class RenameFileTask extends CopyFileTask {
	 ...
	 */
	public synchronized final boolean isBySequence() {
	 ...
	 */
	public synchronized final void setBySequence(final boolean bySequence) {
	 ...
	 */
	public synchronized final void setOrderIndex(final int orderIndex) {
	 ...
	 */
	public synchronized final void setPadding(final int padding) {
	 ...
	 */
	public synchronized final void setRadix(final int radix) {
		this.radix = radix;
	}
	 ...
	 */
	public synchronized final void setStartAt(final String startAt) {
...
class FileSortDate implements Comparator<File> {
	public int compare(final File a, final File b) {
		...
		final int result = (!JIPreferences.getInstance().isThumbnailSortDesend())
			? (int)(a.lastModified() - b.lastModified()) : (int)(b.lastModified() - a.lastModified());
...
class FileSortSize implements Comparator<File> {
	public int compare(final File a, final File b) {
		...
		final int result = (!JIPreferences.getInstance().isThumbnailSortDesend())
			? (int)(a.length() - b.length()) : (int)(b.length() - a.length());
...
//		return (!JIPreferences.getInstance().isTSortDesend())
//			? (a.suffix+a.name+a.path).compareToIgnoreCase((b.suffix+b.name+b.path))
//			: (b.suffix+b.name+b.path).compareToIgnoreCase((a.suffix+a.name+a.path));
